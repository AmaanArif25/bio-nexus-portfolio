      ...
      <div className="container mx-auto px-4">
          ...
          <div>
            ...
            <form className="flex">
              <input 
                ...
                className="bg-purple-900/20 border border-purple-800/30 rounded-l-md px-4 py-2 focus:outline-none focus:border-purple-500 text-white w-full"
              />
              <button 
                type="submit" 
        ...
        <div className="mt-10 pt-6 border-t border-purple-900/30 text-center">
          <p className="text-gray-500">
            &copy; {currentYear} BioNexus. All rights reserved.
          </p>
